...
const createUser = async (req, res) => {
    try {
        ...
        const verificationLink = process.env.NODE_ENV==='dev'?`${process.env.HOST_DEV}:${process.env.PORT}/api/user/verify/${user._id}/${token}`:`${process.env.HOST_PROD}/api/user/verify/${user._id}/${token}`
        const mailContent = {
